...
public class C45 {
	 ...
	 * @param InDiscrete
	 */
	public C45(Matrix m, boolean[] InDiscrete){
		this.Root = new Tree();
	 ...
	 * @param InDiscrete
	 */
	public C45(DataMatrix dm, boolean[] InDiscrete){
		this.Root = new Tree();
		this.matrix = dm;
		this.InDiscrete = InDiscrete;
	 ...
	 * @param node
	 */
	private void _C45(int[] rows, TreeNode node){
		if(rows.length == 0){
			return;
		}
		...
		//System.out.println("特征选取" + index + ",信息增益率" + sort.data[compare.length - 1] + ".");
